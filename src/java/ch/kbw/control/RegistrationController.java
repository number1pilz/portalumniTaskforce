        ...
        if (vorname.isEmpty() || nachname.isEmpty() || email.isEmpty() || passwort1.isEmpty() || passwort2.isEmpty()) {
            ...
            if (checkPasswort() == true && checkEmail() == true) {
                ...
                try {
                    ...
                    message.setFrom(new InternetAddress("noreply@info.portalumni.ch"));
                    message.setRecipients(Message.RecipientType.TO, InternetAddress.parse("fabianulrich00@gmail.com"));    //AN DIESE ADRESSE WIRD EMAIL GESENDET
